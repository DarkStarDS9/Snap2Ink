...
/// A fixed-size, in-memory event log for the link and the studio state machine.
///
...
/// symptoms this exists to catch (a silent stuck reconnect, a send that never resolves) show up on
